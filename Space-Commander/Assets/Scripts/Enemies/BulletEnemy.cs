...
/// <summary>Classe définissant les fonctionnalitées générales d'une bullet ennemie </summary>
public class BulletEnemy : MonoBehaviour
{
    ...
    private void FixedUpdate() => transform.Translate(-target.normalized * speedBullet * Time.deltaTime);
