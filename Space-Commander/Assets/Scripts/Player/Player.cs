...
public class Player : MonoBehaviour
{
    ...
    private void Start() => SliderManager.instance.InitializeSliderPlayer();
   ...
   private IEnumerator TakeDamageTimer()
    ...
    private void Shoot()
    {
        ...
        bullet.GetComponent<Bullet>().InitializeBullet(vectorAim, CheckShootState(freezeProbabily), CheckShootState(fireProbabily));
    ...
    private void FixedUpdate() => transform.parent.Translate(vectorMovement * speed * Time.deltaTime);
    ...
    private void OnEnable() => controller.Player.Enable();

    private void OnDisable() => controller.Player.Disable();
